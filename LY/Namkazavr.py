...
pygame.display.set_caption("Namkazavr game")
clock = pygame.time.Clock()
font = pygame.freetype.Font(None, 40)
cactus_image = pygame.image.load('images/Asis.png')
cactus_image = pygame.transform.scale(cactus_image, (100, 80))
dino_image = pygame.image.load('images/Namka.png')
...
cactus_event = pygame.USEREVENT + 2
pygame.time.set_timer(ground_event, 2000)
pygame.time.set_timer(cactus_event, 10)
